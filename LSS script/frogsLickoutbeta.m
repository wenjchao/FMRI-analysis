...
mkdir(temp_path);
output_path_beta = sprintf('/mnt/sdb/Bank1/DSN_AGE/MRI_Pilot/NII_%s/%s/trial_beta/sub-%s_run-%d_trial-%02d_beta.nii', grp, subID, subID, i_run, i_trial);
output_path_tval = sprintf('/mnt/sdb/Bank1/DSN_AGE/MRI_Pilot/NII_%s/%s/trial_beta/sub-%s_run-%d_trial-%02d_tval.nii', grp, subID, subID, i_run, i_trial);
...
% other_onset = cell(1,length(index(1:end ~= i_trial)));
% other_duration = cell(1, length(index(1:end ~= i_trial)));
% other_index = index(1:end ~= i_trial);
% for i_others = 1: length(index(1:end ~= i_trial))
%     other_onset{i_others} = onsets{other_index(i_others)};
%     other_duration{i_others} = durations{other_index(i_others)};
% end
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = cell2mat(other_onset);
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).duration = cell2mat(other_duration);
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).tmod = 0;
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod = struct('name', {}, 'param', {}, 'poly', {});
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).orth = 1;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).name = 'initiation';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).onset = onsets{2};
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).duration = durations{2};
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).tmod = 0;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).pmod = struct('name', {}, 'param', {}, 'poly', {});
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(2).orth = 1;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).name = 'review';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).onset = onsets{3};
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).duration = durations{3};
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).tmod = 0;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).pmod = struct('name', {}, 'param', {}, 'poly', {});
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(3).orth = 1;
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).name = 'navigation';
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).onset = onsets{4};
matlabbatch{1}.spm.stats.fmri_spec.sess.cond(4).duration = durations{4};
...
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(5).onset = onsets{1};
% matlabbatch{1}.spm.stats.fmri_spec.sess.cond(5).duration = durations{1};
